...
public class LotofacilActivity extends AppCompatActivity {
    ...
    private void gerar() {
        ...
        if(qtdNumeros < 15 || qtdNumeros > 20){
            Toast.makeText(this,"Escolha entre 15 e 20 números",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        for(int i = 1; i <= qtdJogos; i++){
            ...
            //Lotofácil os números vão de 1 a 60
    ...
    private void mostrarJogo(int numeroDoJogo, List<Integer> jogo){
        ...
        for(Integer numero : jogo){
            ...
            bola.setBackgroundResource(R.drawable.bola_lotofacil);
