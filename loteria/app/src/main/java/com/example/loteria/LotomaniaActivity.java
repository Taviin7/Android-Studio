...
public class LotomaniaActivity extends AppCompatActivity {
    ...
    private void gerar() {
        ...
        if(qtdNumeros != 50){
            Toast.makeText(this,"A Lotomania exige exatamente 50 números",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        for(int i = 1; i <= qtdJogos; i++){
            ...
            //Lotomania os números vão de 0 a 99
            List<Integer> jogo = GeradorLoteria.gerar(0,99,qtdNumeros);
            mostrarJogo(i, jogo);
        }
    ...
    private void mostrarJogo(int numeroDoJogo, List<Integer> jogo){
        ...
        for(Integer numero : jogo){
            ...
            bola.setBackgroundResource(R.drawable.bola_lotomania);
