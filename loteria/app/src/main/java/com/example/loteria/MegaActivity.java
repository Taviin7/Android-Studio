...
public class MegaActivity extends AppCompatActivity {
    ...
    private void gerar() {
        ...
        if(qtdNumeros < 6 || qtdNumeros > 15){
            Toast.makeText(this,"Escolha entre 6 e 15 números",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        for(int i = 1; i <= qtdJogos; i++){
            ...
            //Mega-sena os números vão de 1 a 60
    ...
    private void mostrarJogo(int numeroDoJogo, List<Integer> jogo){
        ...
        for(Integer numero : jogo){
            ...
            bola.setBackgroundResource(R.drawable.bola_mega);
